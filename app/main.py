...
from app.handlers.meta_ingest_admin import router as meta_ingest_admin_router
from app.handlers.meta_debug_admin import router as meta_debug_admin_router
...
async def main():
    ...
    dp.include_router(meta_ingest_admin_router)
    dp.include_router(meta_debug_admin_router)
