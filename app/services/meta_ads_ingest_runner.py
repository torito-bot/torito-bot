...
def ingest_seed_products_for_geo(geo_code: str):
    ...
    seed = [
        {
            ...
            "page_name": "Smart Home Deals",
            "media_type": "video",
            "ad_library_url": "https://www.facebook.com/ads/library/",
            "ad_snapshot_url": "https://www.facebook.com/ads/library/",
            "creative_preview_url": "https://www.facebook.com/ads/library/",
    ...
    for item in seed:
        ...
        result.append({
            ...
            "creative_preview_url": item.get("creative_preview_url"),
